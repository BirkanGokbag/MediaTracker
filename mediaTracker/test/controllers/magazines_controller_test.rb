...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { general_medias_id: @magazine.general_medias_id, issue: @magazine.issue } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { general_medias_id: @magazine.general_medias_id, issue: @magazine.issue } }
